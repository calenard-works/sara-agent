 ...
 *
 * Commands:
 * - sara config list [--show-sources]
 * - sara config get <field>
 * - sara config set <field> <value>
 * - sara config delete <field>
 *
 * Examples:
 * - sara config list                    # Show all effective config
 * - sara config list --show-sources     # Show where values come from
 * - sara config get llm.model           # Get specific value
 * - sara config set llm.model gpt-4     # Set global config
 * - sara config delete theme            # Remove config
 */
