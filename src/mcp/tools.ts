 ...
 * MCP Tool Adapter
 *
 * Bridges MCP tools to sara's internal tool system.
 * Converts MCP tool definitions to sara's Tool interface.
 *
 * Key Responsibilities:
 * - Convert MCP tool JSON Schema to Zod schemas
 * - Execute MCP tools through MCP client
 * - Handle MCP tool results and convert to sara format
...
/**
 * Adapter that converts MCP tools to sara's Tool interface
 */
