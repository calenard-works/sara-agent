  ...
  const baseMessages: UIFeedMessage[] = [
    ...
    // 3. Tool message for read-only tool
    {
      ...
      message: {
        ...
        content:
          '{\n  "type": "fileRead",\n  "filePath": "package.json",\n  "content": "{\\"name\\": \"sara\"", \\"version\\": \\"1.0.0\\", \\"scripts\\": {\\"test\\": \\"vitest\\", \\"lint\\": \\"tsc\\"}}",\n  "offset": 0,\n  "limit": 1,\n  "totalLines": 1,\n  "truncated": false\n}',
      },
    },
  ...
  const baseToolCalls: ToolCall[] = [
    // Read-only tool (completed)
    {
      ...
      result: {
        ...
        filePath: "package.json",
        content:
          '{"name": "sara", "version": "1.0.0", "scripts": {"test": "vitest", "lint": "tsc"}}',
        offset: 0,
        limit: 1,
        totalLines: 1,
        truncated: false,
          ...
          tool_calls: [
            ...
            // fileEdit tools
            {
              ...
              function: {
                name: "fileEdit",
                arguments:
                  '{"filePath": "/src/components/UserProfile.tsx", "old_string": "function UserProfile({ name, email }: { name: string; email: string }) {\\n  return (\\n    <div>\\n      <h2>{name}</h2>\\n      <p>{email}</p>\\n    </div>\\n  );\\n}", "new_string": "function UserProfile({ name, email, avatar }: { name: string; email: string; avatar?: string }) {\\n  return (\\n    <div className=\\"user-profile\\">\\n      {avatar && <img src={avatar} alt={name} className=\\"avatar\\" />}\\n      <div className=\\"user-info\\">\\n        <h2>{name}</h2>\\n        <p>{email}</p>\\n      </div>\\n    </div>\\n  );\\n}"}',
              },
            },
            {
              id: "fileEdit-create",
              ...
              function: {
                name: "fileEdit",
                arguments:
                  "{\"filePath\": \"/src/components/Avatar.tsx\", \"old_string\": \"\", \"new_string\": \"import React from 'react';\\n\\ninterface AvatarProps {\\n  src?: string;\\n  alt: string;\\n  size?: 'small' | 'medium' | 'large';\\n  className?: string;\\n}\\n\\nexport function Avatar({ src, alt, size = 'medium', className }: AvatarProps) {\\n  const sizeClasses = {\\n    small: 'w-8 h-8',\\n    medium: 'w-12 h-12',\\n    large: 'w-16 h-16',\\n  };\\n\\n  if (src) {\\n    return (\\n      <img\\n        src={src}\\n        alt={alt}\\n        className={\\`\\${sizeClasses[size]} rounded-full object-cover \\${className || ''}\\`}\\n      />\\n    );\\n  }\\n\\n  // Default avatar with initials\\n  const initials = alt.split(' ').map(word => word[0]).join('').toUpperCase();\\n  \\n  return (\\n    <div className={\\`\\${sizeClasses[size]} rounded-full bg-gray-300 flex items-center justify-center text-gray-600 font-semibold \\${className || ''}\\`}>\\n      {initials}\\n    </div>\\n  );\\n}\"}",
              },
            },
            {
              id: "fileEdit-error",
              ...
              function: {
                name: "fileEdit",
                arguments:
                  '{"filePath": "/nonexistent.txt", "old_string": "some content", "new_string": "new content"}',
              },
            },
            {
              id: "fileEdit-abort",
              ...
              function: {
                name: "fileEdit",
                arguments:
                  '{"filePath": "/huge/file.txt", "old_string": "old content", "new_string": "new content"}',
              },
            },
            {
              ...
              function: {
                name: "fileEdit",
                arguments:
                  '{"filePath": "/etc/passwd", "old_string": "old content", "new_string": "new content"}',
              },
            },
            // grep tools
            {
            ...
            // Unknown tools
            {
              ...
              function: {
                name: "fileWrite",
                arguments:
                  '{"filePath": "/tmp/test.txt", "content": "test content"}',
              },
            },
            {
              ...
              function: {
                name: "fileCreate",
                arguments:
                  '{"filePath": "/tmp/new.txt", "content": "new content"}',
              },
            },
            {
              id: "deploy-unknown",
            ...
            },
            {
              ...
              function: {
                name: "sendEmail",
                arguments:
                  '{"to": "user@example.com", "subject": "Test", "body": "Test email"}',
              },
            },
          ],
        },
